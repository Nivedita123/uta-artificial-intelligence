...
public class LogicalExpression {
	...
	private Vector<LogicalExpression> subexpressions = null; // a vector of LogicalExpressions ( basically a vector of
																// unique symbols and subexpressions )
	...
	public LogicalExpression(LogicalExpression oldExpression) {
		...
		if (oldExpression.getUniqueSymbol() == null) {
			...
			for (Enumeration<LogicalExpression> e = oldExpression.getSubexpressions().elements(); e
					.hasMoreElements();) {
	...
	/*
	 * this method replaces _part_ of read_word() this method sets the symbol for
	 * the LogicalExpression it checks to make sure that it starts with one of the
	 * appropriate letters, then checks to make sure that the rest of the string is
	 * either digits or '_'
	 */
	...
	/*
	 * this method replaces _part_ of read_word() from the example code it sets the
	 * connective for this LogicalExpression
	 * 
